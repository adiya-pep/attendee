...
SECURE_SSL_REDIRECT = os.getenv("DISABLE_SSL_REDIRECT", "false") != "true"
SECURE_HSTS_SECONDS = 60 if SECURE_SSL_REDIRECT else 0
SESSION_COOKIE_SECURE = os.getenv("DISABLE_SSL_REDIRECT", "false") != "true"
CSRF_COOKIE_SECURE = os.getenv("DISABLE_SSL_REDIRECT", "false") != "true"
...
if os.getenv("DISABLE_EMAIL", "false") != "true":
    ...
    # Disable email verification when email is disabled
